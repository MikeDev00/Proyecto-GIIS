...
#    flname  = models.CharField('Nombre de Archivo',max_length=100, blank=True, null = True)
    freq = models.FloatField('Frecuencia (Hz)',max_length=100)
    freq2 = models.FloatField('Frecuencia (Hz)',max_length=100)
    duration  = models.FloatField('Duración',max_length=100)
